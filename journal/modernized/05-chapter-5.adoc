...
stumble and be confounded.--So when the disciples asked him why he spoke in parables,
...
and spoke of them in very instructive metaphors and expressions,
...
the Lord is gracious through it all, and wounds to heal, yes, kills to make alive.
